...
const $$Timeline = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="timeline-section" data-timeline${addAttribute(`--n:${scenes.length}; --tail:0.6;`, "style")} data-astro-cid-zd5g3drv> <div class="container" data-astro-cid-zd5g3drv> <header class="timeline-header" data-astro-cid-zd5g3drv> <h2 class="timeline-title" data-astro-cid-zd5g3drv>Conoce nuestra historia y trayectoria</h2> </header> <nav class="timeline-mobile-nav" aria-label="Navegacion por años" data-astro-cid-zd5g3drv> ${mobileYears.map((year, idx) => renderTemplate`<button type="button"${addAttribute(`mobile-year-chip${idx === 0 ? " is-active" : ""}`, "class")}${addAttribute(year, "data-mobile-year")}${addAttribute(`mobile-item-${scenes.findIndex((s) => s.year === year)}`, "data-target")} data-astro-cid-zd5g3drv> ${year} </button>`)} </nav> <div class="timeline-mobile-list" data-astro-cid-zd5g3drv> ${scenes.map((item, index) => renderTemplate`<details class="timeline-mobile-item" data-mobile-item${addAttribute(item.year, "data-year")}${addAttribute(`mobile-item-${index}`, "id")}${addAttribute(index === 0, "open")} data-astro-cid-zd5g3drv> <summary data-astro-cid-zd5g3drv> <span class="mobile-item-year" data-astro-cid-zd5g3drv>${item.year}</span> <span class="mobile-item-title" data-astro-cid-zd5g3drv>${item.layout === "outro" ? "Actualidad" : item.title}</span> </summary> <div class="mobile-item-body" data-astro-cid-zd5g3drv> ${item.layout === "outro" ? renderTemplate`<p data-astro-cid-zd5g3drv>${item.tagline ?? "Construyendo hoy, proyectando el manana."}</p>` : renderTemplate`<p data-astro-cid-zd5g3drv>${item.description}</p>`} ${item.image ? renderTemplate`<img${addAttribute(item.image.src, "src")}${addAttribute(item.imageAlt ?? item.title, "alt")} loading="lazy" data-astro-cid-zd5g3drv>` : null} </div> </details>`)} </div> <div class="timeline-track" data-track data-astro-cid-zd5g3drv> <div class="timeline-stage" data-stage data-astro-cid-zd5g3drv> <div class="timeline-axis" aria-hidden="true" data-astro-cid-zd5g3drv> <div class="axis-line" data-astro-cid-zd5g3drv></div> <div class="axis-progress" data-astro-cid-zd5g3drv></div> </div> <div class="timeline-scenes" data-astro-cid-zd5g3drv> ${scenes.map((item, index) => renderTemplate`${renderComponent($$result, "TimelineItem", $$Timelineitem, { ...item, "index": index, "data-astro-cid-zd5g3drv": true })}`)} </div> </div> </div> </div> </section>  ${renderScript($$result, "D:/ttt/Paginaweb/LandingPage/super-shell/src/components/sections/nosotros/timeline.astro?astro&type=script&index=0&lang.ts")}`;
