...
function ProyectoCardView({ project, href, className, children }) {
  ...
  const Inner = /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "body", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "meta", children: project.cliente }),
